...

{
	int S1;
	int S2;
public void Mumbai_fare()
{
	Scanner sc = new Scanner(System.in);
	int f1=330;
	System.out.println("Please Select Your Bus");
	System.out.println("1.Shivshai (Addon fare=150)");
	System.out.println("2.MSRTC (Addon fare=90)");
	System.out.println("3.Humsafar  (Addon fare=120)");
	int f2=sc.nextInt();
	...
	System.out.println("1.Sleeper (Addon fare=180) ");
	System.out.println("2.Genral (Addon fare=50)");
	System.out.println("3.AC (Addon fare=160)");
